function [] = plotCorrelation_regressionfit(tvp,plotfname,Plot_No)
...
size=17;
  ...
  if Plot_No==1
  xlabel('True fracture ratio %','fontsize',size);
  ylabel('Predicted fracture ratio using non linear regresion model%','fontsize',size);
