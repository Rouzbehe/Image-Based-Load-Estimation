...
net = NeuralNet2([size(X,2) 20 10 8 6 4 size(Y,2)]);
net.LearningRate = 0.1;
net.RegularizationType = 'L1';
...
% compute predictions
disp('Test...'); tic
predictTrain = net.sim(Xtrain);
predictTest = net.sim(Xtest);
[OUT,OUTS]= net.sim(Xtest);
toc

figure (13)

plot(Ytest,predictTest,'k*','markers',7)
% hold on 
% plot([0,3],[0,3],'--k')
% 
% figure (14)
% plot(predictTrain,Ytrain,'k*','markers',7)
