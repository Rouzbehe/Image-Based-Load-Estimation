...
% filterimage=filter(croppedImage,[350, 50]);
filterimage=Image(:,:,2);
% filterimage=Image;
...
% filterimage=bwmorph(filterimage,'fill');
 ...
 Binaryimage=~im2bw(filterimage,0.95);
 
         maxgray=40;mingray=240 ; % work with croppedImage(:,:,2); if the back ground was redish (used for DC_P1-DC_P5)
